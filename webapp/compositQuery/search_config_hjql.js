...
var search_config = {
    ...
    HJQL_HJQLXXB : [
        ...
        {field:'HKSZDPCS',text:'户籍单位',input:'textbox_org',judge_dict: judge12,isOrganization:true,lishu:{sj:'HJGXSJDM',fxj:'HJGXFJDM',pcs:'HKSZDPCS'},dataFilter:'00,10,21,32'},
...
/*        {field:'SYSJ',text:'剩余时间',input:'textbox',judge_dict: judge1},*/
        ...
        {field:'XTPCSCODE',text:'协同单位',input:'textbox_org',judge_dict: judge12,isOrganization:true,lishu:{sj:'XTGXSJDM',fxj:'XTGXFJDM',pcs:'XTPCSCODE'},dataFilter:'00,10,21,32'},
