...
PDFJS.imageResourcesPath = staticPath + '/common/pdfjs/images/';
PDFJS.workerSrc = staticPath + '/common/pdfjs/pdf.worker.js';
PDFJS.cMapUrl = staticPath + '/common/pdfjs/cmaps/';
  ...
  load: function pdfViewLoad(pdfDocument, scale) {
    ...
    firstPagePromise.then(function(pdfPage) {
      ...
      if (!PDFJS.disableHistory && !self.isViewerEmbedded) {
        ...
        // i.e. not when it is embedded in a pdfjs page.
    ...
    Promise.all([firstPagePromise, storePromise, defaultZoomValuePromise]).then(
        function resolved() {
          ...
          // unless the viewer is embedded in a pdfjs page.
