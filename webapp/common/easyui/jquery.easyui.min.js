...
(function ($) {
    ...
    function _2ad(_2ae) {
        ...
        dlg.dialog($.extend({}, _2ae, {
            noheader: (_2ae.title ? false : true), onClose: function () {
                _2a9();
                if (_2ae.onClose) {
...
(function ($) {
    ...
    function _3a8(_3a9, _3aa, el) {
        ...
        _3b0.resizable($.extend({}, {
            handles: (_3af[dir] || ""), disabled: (!pp.panel("options").split), onStartResize: function (e) {
                _398 = true;
    ...
    function _3ba(_3bb, _3bc, _3bd) {
        ...
        function _3c3() {
            ...
            if (_3bc == "east") {
                ...
                return {
                    resizeC: {width: _3ca},
                    expand: {left: cc.width() - _3c9},
                    expandP: {top: _3c7.top, left: cc.width() - _3c8, width: _3c8, height: _3c7.height},
                    collapse: {left: cc.width(), top: _3c7.top, height: _3c7.height}
                };
            } else {
                if (_3bc == "west") {
                    var _3c9 = p.panel("panel")._outerWidth();
                    ...
                    return {
                        resizeC: {width: _3ca, left: _3c8 - 1},
                        expand: {left: 0},
                        expandP: {left: 0, top: _3c7.top, width: _3c8, height: _3c7.height},
                        collapse: {left: -_3c9, top: _3c7.top, height: _3c7.height}
                    };
                } else {
                    if (_3bc == "north") {
                        ...
                        return {
                            resizeC: {top: _3c8 - 1, height: hh},
                            expand: {top: 0},
                            expandP: {top: 0, left: 0, width: cc.width(), height: _3c8},
                            collapse: {top: -_3cb, width: cc.width()}
                        };
                    } else {
                        if (_3bc == "south") {
                            var _3cb = p.panel("panel")._outerHeight();
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _3cb},
                                expandP: {top: cc.height() - _3c8, left: 0, width: cc.width(), height: _3c8},
    ...
    function _3cc(_3cd, _3ce) {
        ...
        function _3d3() {
            ...
            if (_3ce == "east" && _3cf.expandEast) {
                return {
                    collapse: {left: cc.width(), top: _3d4.top, height: _3d4.height},
                    expand: {left: cc.width() - p.panel("panel")._outerWidth()}
                };
            } else {
                if (_3ce == "west" && _3cf.expandWest) {
                    return {
                        collapse: {left: -p.panel("panel")._outerWidth(), top: _3d4.top, height: _3d4.height},
                        expand: {left: 0}
                    };
                } else {
    ...
    $.fn.layout.defaults = {
        fit: false, onExpand: function (_3ed) {
...
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        ...
        novalidate: false,
        events: {
            focus: _488, blur: _48c, mouseenter: _490, mouseleave: _493, click: function (e) {
                var t = $(e.data.target);
                if (!t.is(":focus")) {
                    t.trigger("focus");
                }
        ...
        tipOptions: {
            showEvent: "none", hideEvent: "none", showDelay: 0, hideDelay: 0, zIndex: "", onShow: function () {
                $(this).tooltip("tip").css({color: "#fff", borderColor: "#000", backgroundColor: "#000"});
            }, onHide: function () {
                $(this).tooltip("destroy");
            }
        },
...
(function ($) {
    ...
    function _4ce(_4cf) {
        ...
        _4d0.validatebox($.extend({}, opts, {
            deltaX: $(_4cf).textbox("getTipX"), onBeforeValidate: function () {
                var box = $(this);
                if (!box.is(":focus")) {
    ...
    $.fn.textbox.parseOptions = function (_4f4) {
        var t = $(_4f4);
        return $.extend({}, $.fn.validatebox.parseOptions(_4f4), $.parser.parseOptions(_4f4, ["prompt", "iconCls", "iconAlign", "buttonText", "buttonIcon", "buttonAlign", {
            multiline: "boolean",
            editable: "boolean",
            iconWidth: "number"
        }]), {
...
(function ($) {
    ...
    function load(_523, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _524, dataType: "json", success: function (data) {
                    _525(data);
                }, error: function () {
...
(function ($) {
    ...
    function _614(_615) {
        ...
        _617.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_618, _619) {
    ...
    var _745 = $.extend({}, _737(["text", "textbox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
    ...
    $.fn.datagrid.parseOptions = function (_78d) {
        var t = $(_78d);
        return $.extend({}, $.fn.panel.parseOptions(_78d), $.parser.parseOptions(_78d, ["url", "toolbar", "idField", "sortName", "sortOrder", "pagePosition", "resizeHandle", {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        ...
        showFooter: false,
        scrollbarSize: 18,
        rowEvents: {mouseover: _635(true), mouseout: _635(false), click: _63d, dblclick: _647, contextmenu: _64b},
        ...
        loader: function (_7db, _7dc, _7dd) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _7db, dataType: "json", success: function (data) {
                    _7dc(data);
                }, error: function () {
...
(function ($) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        ...
        loader: function (_929, _92a, _92b) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _929, dataType: "json", success: function (data) {
                    _92a(data);
                }, error: function () {
    ...
    function _935(_936) {
        ...
        $(_936).datagrid($.extend({}, opts, {
            ...
            columns: (opts.columns && opts.columns.length) ? opts.columns : [[{
                field: opts.textField, width: "100%", formatter: function (_937, row, _938) {
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: {click: _968, keydown: _96c, paste: _96c, drop: _96c},
        panelWidth: null,
        panelHeight: 200,
        panelMinWidth: null,
        panelMaxWidth: null,
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupField: null, groupFormatter: function (_9de) {
            return _9de;
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _9df, dataType: "json", success: function (data) {
                    _9e0(data);
                }, error: function () {
