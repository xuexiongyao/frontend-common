...
(function ($) {
    ...
    $.fn.tree.parseOptions = function (_122) {
        var t = $(_122);
        return $.extend({}, $.parser.parseOptions(_122, ["url", "method", {
            checkbox: "boolean",
    ...
    $.fn.tree.defaults = {
        ...
        loader: function (_12e, _12f, _130) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _12e, dataType: "json", success: function (data) {
                    _12f(data);
                }, error: function () {
        ...
        view: _127,
        onBeforeLoad: function (node, _132) {
        },
