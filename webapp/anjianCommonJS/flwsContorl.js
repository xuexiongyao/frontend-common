    ...
    $('#flws_cl_area_' + bm + ' form').form('submit', {
        onSubmit: function () {
            ...
            if (isValid) {
                ...
                //textbox框(换行文本)的处理
                var textboxArry = $('#flws_cl_area_' + bm + ' form a>textarea');
                if(textboxArry){
                ...
                //日期插件my97单独处理
                var dateArry = $('#flws_cl_area_' + bm + ' form a input.Wdate');
                ...
                //除了日期之外的组件
                var dataArry = $('#flws_cl_area_' + bm + ' form a input[type="hidden"]');
...
function shongshen() {
    ...
    selectName(DATA.CQBG.cqbgZj,DATA.CQBG.asjflwsdm);
}
